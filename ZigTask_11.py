...
class Puzzle():
    ...
    def AttemptPuzzle(self):
        ...
        while not Finished:
            ...
            LeverUsage = input("Do you want to use the lever (Y/N):")
            ...
            if LeverUsage == "Y" and LeverUsageCount == 0 and LeverCount > 0:
                print(LeverCount)
                LeverUsageCount = 1
                ...
                try:
                    AmountToAddToScore, Lever = self.CheckforMatchWithPattern(Row, Column)
                    if Lever == "Y":
                        LeverCount += 1
                except:
