...
class Puzzle():
    ...
    def AttemptPuzzle(self):
        ...
        while not Finished:
            ...
            if self.CheckforMatchWithPattern(Row, Column) > 0 and self.__AvailableWildcards != 0:
                print("This cell is already a part of a pattern, a Wildcard has been placed!")
                self.__AvailableWildcards -= 1
            ...
            print(f"You have {self.__AvailableWildcards} Wildcards Left!")
        print()
        self.DisplayPuzzle()
        print()
        return self.__Score
