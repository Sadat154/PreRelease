...
class Puzzle():
    ...
    def AttemptPuzzle(self):
        ...
        while not Finished:
            ...
            print("Number of Symbols/Turns Left: " + str(self.__SymbolsLeft))
            RemoveCheck = (input("Would you like to remove a symbol? (Y/N)")).upper()
            Row = -1
            Valid = False
            while not Valid:
                try:
            ...
            if RemoveCheck == "N":
                ...
                #if CurrentCell == "" or CurrentCell.CheckSymbolAllowed("@") == False or CurrentCell.CheckSymbolAllowed("T") == False  or CurrentCell.CheckSymbolAllowed("Q") == False  or CurrentCell.CheckSymbolAllowed("X") == False:
                if CurrentCell == "" or CurrentCell.CheckSymbolAllowed("@") == False or CurrentCell.CheckSymbolAllowed(CurrentCell.GetSymbol()) == False:
                    print("Invalid Location!")
                else:
                    print("Symbol removed breh")
                    CurrentCell.ChangeSymbolInCell("")
                    self.__SymbolsLeft += 1
                    #or self.__Grid[(self.__GridSize - Row) * self.__GridSize + Column - 1] = Cell() <-- ACTUALLY removes the cell
            else:
                print("Try Again, please input a valid choice!")
